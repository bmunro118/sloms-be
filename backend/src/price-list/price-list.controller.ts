...
export class PriceListController {
  ...
  @ApiOperation({
    summary:
      'Activate a revision — promotes a draft or rolls back to an archived one',
  })
  @ApiParam({ name: 'id', type: Number })
  ...
  @Roles(Role.ReadOnly, Role.Operative, Role.Manager, Role.Admin)
  @ApiOperation({
    summary: 'Export price list as CSV (defaults to active revision)',
  })
  ...
  @ApiOperation({
    summary: 'Import price list from CSV — creates a draft revision',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    type: Boolean,
    description: 'Validate and summarise without writing',
  })
  @ApiQuery({
    name: 'merge',
    required: false,
    type: Boolean,
    description: 'Merge CSV into active revision rather than replacing',
  })
  @ApiOkResponse({
    description: 'Import summary. revision is null when dryRun=true.',
  })
  importCsv(
  ...
  @Roles(Role.ReadOnly, Role.Operative, Role.Manager, Role.Admin)
  @ApiOperation({
    summary: 'List all price list items (defaults to active revision)',
  })
